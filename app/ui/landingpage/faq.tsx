...
///////////////////////////////////////////////////////////////////////////////
// Hinweis: Funktionierender FAQ-Component, jedoch derzeit nicht in Verwendung!
///////////////////////////////////////////////////////////////////////////////
...
const FaqItem: React.FC<FaqProps> = ({ question, answer }) => (
  <div className="py-5">
    <details className="group">
      ...
      <p className="group-open:animate-fadeIn mt-3 text-neutral-600 text-justify">{answer}</p>
    </details>
  </div>
);
